addEventListener('message', (d) => {
	...
	for (var i = row*(BoardWidth*4); i < (row+1)*(BoardWidth*4); i += 4) {
		...
		if (map.data[i] == 0 && map.data[i + 1] == 0 && map.data[i + 2] == 0) {
			Board += ("<img src='./Images/border.png' class='Tile' id='" + row + Delimiter + (i / 4) % BoardWidth + "' style='display:none; width:30px; height:30px; ");
			rowContent.push(0);
		}
		//Deep Water
		else if (map.data[i] == 0 && map.data[i + 1] == 0 && map.data[i + 2] == 153) {
			Board += ("<img src='./Images/deepWater.png' class='Tile' id='" + row + Delimiter + (i / 4) % BoardWidth + "' style='display:none; width:30px; height:30px; ");
			rowContent.push(0);
		}
		//trees
		else if (map.data[i] == 0 && map.data[i + 1] == 153 && map.data[i + 2] == 0) {
			Board += ("<img src='./Images/trees.png' class='Tile' id='" + row + Delimiter + (i / 4) % BoardWidth + "' style='display:none; width:30px; height:30px; ");
			rowContent.push(0);
		}
		//trees tops
		else if (map.data[i] == 102 && map.data[i + 1] == 255 && map.data[i + 2] == 153) {
			Board += ("<img src='./Images/TreeTop.png' class='Tile' id='" + row + Delimiter + (i / 4) % BoardWidth + "' style='display:none; width:30px; height:30px; ");
			rowContent.push(0);
		}
		//Door
		else if (map.data[i] == 255 && map.data[i + 1] == 255 && map.data[i + 2] == 102) {
			Board += ("<img src='./Images/door.png' class='Tile' id='" + row + Delimiter + (i / 4) % BoardWidth + "' style='display:none; width:30px; height:30px; ");
			rowContent.push(3);
		}
		//Horizontal wall
		else if (map.data[i] == 102 && map.data[i + 1] == 102 && map.data[i + 2] == 102) {
			Board += ("<img src='./Images/HorWall.png' class='Tile' id='" + row + Delimiter + (i / 4) % BoardWidth + "' style='display:none; width:30px; height:30px; ");
			rowContent.push(0);
		}
		//Bottom Left corner wall
		else if (map.data[i] == 51 && map.data[i + 1] == 51 && map.data[i + 2] == 51) {
			Board += ("<img src='./Images/CornerWall.png' class='Tile' id='" + row + Delimiter + (i / 4) % BoardWidth + "' style='display:none; width:30px; height:30px; ");
			rowContent.push(0);
		} 
		//Vertical wall
		else if (map.data[i] == 204 && map.data[i + 1] == 102 && map.data[i + 2] == 102) {
			Board += ("<img src='./Images/VertWall.png' class='Tile' id='" + row + Delimiter + (i / 4) % BoardWidth + "' style='display:none; width:30px; height:30px; ");
			rowContent.push(0);
		}
		//Top Left corner wall
		else if (map.data[i] == 204 && map.data[i + 1] == 153 && map.data[i + 2] == 153) {
			Board += ("<img src='./Images/CornerWall.png' class='Tile' id='" + row + Delimiter + (i / 4) % BoardWidth + "' style='display:none; width:30px; height:30px; transform: rotate(90deg); ");
			rowContent.push(0);
		}
		//Top Right corner wall
		else if (map.data[i] == 153 && map.data[i + 1] == 102 && map.data[i + 2] == 102) {
			Board += ("<img src='./Images/CornerWall.png' class='Tile' id='" + row + Delimiter + (i / 4) % BoardWidth + "' style='display:none; width:30px; height:30px; transform: rotate(180deg); ");
			rowContent.push(0);
		}
		//Top Left corner wall
		else if (map.data[i] == 102 && map.data[i + 1] == 51 && map.data[i + 2] == 51) {
			Board += ("<img src='./Images/CornerWall.png' class='Tile' id='" + row + Delimiter + (i / 4) % BoardWidth + "' style='display:none; width:30px; height:30px; transform: rotate(270deg); ");
			rowContent.push(0);
		}
		//end of wall
